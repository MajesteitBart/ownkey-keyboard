...
| File | Source | License |
| --- | --- | --- |
| `clean_en.txt`, `clean_nl.txt` | Sentences from [Tatoeba](https://tatoeba.org), per-language exports | CC BY 2.0 FR |
...
| `real_nl_extra.tsv`, `oov.txt` | Hand-written | Apache-2.0, same as this repository |

`tools/autocorrect-datasets/prepare.py` regenerates the downloaded files.
