...
internal suspend fun runFullBenchmark(
    ...
    report.add(benchmark.evaluateTypos("tap EN usage, EN, with taps", enOnly, s.tapEnUsage.pairs, useTaps = true))
    report.add(benchmark.evaluateTypos("tap EN uniform, EN, with taps", enOnly, s.tapEnUniform.pairs, useTaps = true))
    report.add(benchmark.evaluateTypos("tap NL usage, NL, with taps", nlOnly, s.tapNlUsage.pairs, useTaps = true))
    report.add(benchmark.evaluateTypos("tap NL uniform, NL, with taps", nlOnly, s.tapNlUniform.pairs, useTaps = true))
    report.add(benchmark.evaluateTypos("tap NL usage, NL+EN, with taps", nlEn, s.tapNlUsage.pairs, useTaps = true))
    report.add(benchmark.evaluateTypos("context EN, EN, with taps", enOnly, s.contextEn.pairs, useTaps = true))
    report.add(benchmark.evaluateTypos("context NL, NL, with taps", nlOnly, s.contextNl.pairs, useTaps = true))
    ...
    report.add(benchmark.evaluateCleanText("clean EN, EN, with taps", enOnly, s.cleanEn, TapNoiseTypoGenerator(3001)))
    report.add(benchmark.evaluateCleanText("clean NL, NL, with taps", nlOnly, s.cleanNl, TapNoiseTypoGenerator(3002)))
    report.add(benchmark.evaluateCleanText("clean NL, NL+EN, with taps", nlEn, s.cleanNl, TapNoiseTypoGenerator(3003)))
    report.add(benchmark.evaluateOov("oov.txt, NL+EN", nlEn, s.oov))
    report.add(benchmark.evaluateOov("oov.txt, EN", enOnly, s.oov))
    report.add(benchmark.evaluateOov("oov.txt, NL+EN, with taps", nlEn, s.oov, tapSource = TapNoiseTypoGenerator(4001)))
    report.add(benchmark.evaluateOov("oov.txt, EN, with taps", enOnly, s.oov, tapSource = TapNoiseTypoGenerator(4002)))
