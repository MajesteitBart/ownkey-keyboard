...
- [x] Recognition fires one system-respecting haptic and exposes visible/semantic `Speak an edit` feedback before recording continues after finger release.
