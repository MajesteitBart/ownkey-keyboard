...
- `:app:testDebugUnitTest`: 624 tests, 0 failures, 1 skipped (the opt-in tuning sweep). Isolated-word, real-world and clean-text benchmark numbers are unchanged; context typos fixed EN 77.9 -> 78.3%, NL 69.1 -> 69.6% after the dataset corrections, precision 99.1% or higher.
