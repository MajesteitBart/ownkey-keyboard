...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| tap EN usage, EN | 1500 | 70.5 | 0.7 | 99.0 | 86.9 | 91.5 | 0.0 | 64 | 466 |
| tap EN uniform, EN | 1500 | 44.5 | 1.1 | 97.5 | 80.3 | 87.5 | 0.0 | 60 | 274 |
| tap NL usage, NL | 1500 | 69.3 | 0.3 | 99.5 | 86.6 | 90.6 | 0.0 | 65 | 281 |
| tap NL uniform, NL | 1500 | 48.3 | 1.1 | 97.8 | 82.4 | 86.9 | 0.0 | 56 | 203 |
| tap NL usage, NL+EN | 1500 | 62.3 | 0.8 | 98.7 | 85.3 | 90.2 | 1.1 | 82 | 440 |
| tap EN usage, NL+EN | 1500 | 59.7 | 0.8 | 98.7 | 84.4 | 91.3 | 0.7 | 81 | 810 |
| tap NL uniform, NL+EN | 1500 | 38.6 | 0.7 | 98.3 | 81.4 | 86.9 | 0.6 | 74 | 349 |
| harness EN usage, EN (optimistic) | 1113 | 69.1 | 0.9 | 98.7 | 91.6 | 98.4 | 0.0 | 57 | 182 |
| real EN curated, EN | 100 | 82.0 | 0.0 | 100.0 | 95.0 | 95.0 | 0.0 | 50 | 175 |
| real EN Wikipedia, EN | 3941 | 29.3 | 0.7 | 97.6 | 62.4 | 64.1 | 0.1 | 30 | 116 |
| EN missing apostrophes, EN | 14 | 100.0 | 0.0 | 100.0 | 100.0 | 100.0 | 0.0 | 65 | 358 |
| real NL curated, NL | 60 | 90.0 | 0.0 | 100.0 | 100.0 | 100.0 | 0.0 | 67 | 985 |
| real NL extra, NL | 141 | 86.5 | 0.0 | 100.0 | 94.3 | 97.9 | 0.0 | 61 | 300 |
| real NL all, NL+EN | 201 | 86.1 | 0.0 | 100.0 | 95.5 | 98.5 | 0.0 | 78 | 311 |
| context EN, EN | 1557 | 66.3 | 0.5 | 99.2 | 85.8 | 89.9 | 0.0 | 72 | 523 |
| context NL, NL | 1564 | 62.1 | 1.0 | 98.5 | 82.4 | 88.3 | 0.0 | 72 | 372 |
| context NL, NL+EN | 1564 | 56.2 | 0.8 | 98.5 | 80.8 | 87.5 | 1.2 | 82 | 627 |
| context EN, NL+EN | 1557 | 58.2 | 0.6 | 98.9 | 84.5 | 89.5 | 1.3 | 83 | 265 |
| context EN, EN, words before removed | 1557 | 66.3 | 0.5 | 99.2 | 85.8 | 89.9 | 0.0 | 52 | 191 |
| context NL, NL, words before removed | 1564 | 62.1 | 1.0 | 98.5 | 82.4 | 88.3 | 0.0 | 54 | 178 |
...
| --- | --- | --- | --- | --- |
| real-word EN, EN | 59 | 10.2 | 40.7 | 0 |
| real-word NL, NL | 37 | 0.0 | 75.7 | 0 |
| real-word NL, NL+EN | 37 | 0.0 | 73.0 | 0 |
...
## Examples
- real-word EN, EN, intended word not first: then [then, the, them] (meant than); then [then, the, them] (meant than); then [then, the, them] (meant than); then [then, the, them] (meant than); than [than, thank, thanks] (meant then); than [than, thank, thanks] (meant then); your [your, yours, yourself] (meant you're); your [your, yours, yourself] (meant you're); you're [you're, you've] (meant your); you're [you're, you've] (meant your); it's [it's, it'd, its] (meant its); there [there, there's, there'll] (meant they're)
- real-word NL, NL, intended word not first: word [word, wordt, worden] (meant wordt); word [word, wordt, worden] (meant wordt); word [word, wordt, worden] (meant wordt); wordt [wordt, word, worst] (meant word); Wordt [wordt, word, worst] (meant word); vind [vind, vinden, vindt] (meant vindt); vind [vind, vinden, vindt] (meant vindt); Vindt [vindt, vind, bindt] (meant vind); vindt [vindt, vind, bindt] (meant vind); gebeurt [gebeurt, gebeurtenis, gebeurtenissen] (meant gebeurd); gebeurt [gebeurt, gebeurtenis, gebeurtenissen] (meant gebeurd); gebeurd [gebeurd, gebeurde, gebeurt] (meant gebeurt)
- real-word NL, NL+EN, intended word not first: word [word, wordt, worden] (meant wordt); word [word, wordt, worden] (meant wordt); word [word, wordt, worden] (meant wordt); wordt [wordt, worst, word] (meant word); Wordt [wordt, worst, word] (meant word); vind [vind, vinden, vindt] (meant vindt); vind [vind, vinden, vindt] (meant vindt); Vindt [vindt, vind, bindt] (meant vind); vindt [vindt, vind, bindt] (meant vind); gebeurt [gebeurt, gebeurtenis, gebeurtenissen] (meant gebeurd); gebeurt [gebeurt, gebeurtenis, gebeurtenissen] (meant gebeurd); gebeurd [gebeurd, gebeurde, gebeurt] (meant gebeurt)
...
- context EN, EN, wrong: bre->be (meant bee); nuo->no (meant into); likse->like (meant likes); akd->and (meant take); awter->water (meant lawyer); kving->king (meant going); awt->at (meant want); thhs->this (meant the)
- context EN, EN, missed: cosnultant [consultant] (meant consultant); opwning [opening, owning] (meant opening); bega [began, begat, beg] (meant began); wantz [wants, want, waltz] (meant wants); instrictor [instructor] (meant instructor); sausafee [] (meant sausage); evee [ever, eve, even] (meant ever); completde [complete, completed] (meant completed)
- context NL, NL, wrong: ascht->acht (meant wacht); kleiin->klein (meant kleine); verveet->vergeet (meant verveelt); daat->dat (meant daar); vermkoeden->vermoeden (meant vermoorden); mke->me (meant moe); gxaan->gaan (meant gedaan); olgend->volgend (meant volgende)
- context NL, NL, missed: ijn [zijn, in, mijn] (meant zijn); ou [zou, oud, oude] (meant zou); blssenn [] (meant bossen); vloeustof [vloeistof] (meant vloeistof); puut [put, puur, punt] (meant put); uzur [uur, zuur] (meant zuur); tebtamen [] (meant tentamen); vdrachting [] (meant verachting)
- context NL, NL+EN, wrong: ascht->acht (meant wacht); kleiin->klein (meant kleine); verveet->vergeet (meant verveelt); daat->dat (meant daar); tto->to (meant tot); gxaan->gaan (meant gedaan); olgend->volgend (meant volgende); wse->we (meant war)
- context NL, NL+EN, missed: ijn [in, zijn, mijn] (meant zijn); ou [you, out, our] (meant zou); ceent [cent, cement, meent] (meant cent); blssenn [] (meant bossen); vloeustof [vloeistof] (meant vloeistof); uzur [uur, zuur] (meant zuur); tebtamen [] (meant tentamen); horveelheid [hoeveelheid] (meant hoeveelheid)
- context EN, NL+EN, wrong: bre->be (meant bee); bgen->ben (meant began); unee->nee (meant under); likse->like (meant likes); eenn->een (meant been); akd->and (meant take); awter->water (meant lawyer); frred->fred (meant freed)
- context EN, NL+EN, missed: cosnultant [consultant] (meant consultant); opwning [opening, owning] (meant opening); neess [needs, ness] (meant needs); bega [bega, began, begaan] (meant began); wantz [wants, want, waltz] (meant wants); instrictor [instructor] (meant instructor); sausafee [] (meant sausage); evee [ever, eve, even] (meant ever)
