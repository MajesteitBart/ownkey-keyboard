...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| tap EN usage, EN | 1500 | 70.5 | 0.7 | 99.0 | 86.9 | 91.5 | 0.0 | 84 | 469 |
| tap EN uniform, EN | 1500 | 44.5 | 1.1 | 97.5 | 80.3 | 87.5 | 0.0 | 99 | 455 |
| tap NL usage, NL | 1500 | 69.3 | 0.3 | 99.5 | 86.6 | 90.6 | 0.0 | 72 | 271 |
| tap NL uniform, NL | 1500 | 48.3 | 1.1 | 97.8 | 82.4 | 86.9 | 0.0 | 52 | 174 |
| tap NL usage, NL+EN | 1500 | 62.3 | 0.8 | 98.7 | 85.3 | 90.1 | 1.1 | 100 | 340 |
| tap EN usage, NL+EN | 1500 | 59.7 | 0.8 | 98.7 | 84.4 | 91.3 | 0.7 | 91 | 320 |
| tap NL uniform, NL+EN | 1500 | 38.6 | 0.7 | 98.3 | 81.4 | 86.9 | 0.6 | 63 | 147 |
| harness EN usage, EN (optimistic) | 1113 | 69.1 | 0.9 | 98.7 | 91.6 | 98.4 | 0.0 | 42 | 129 |
| real EN curated, EN | 100 | 82.0 | 0.0 | 100.0 | 95.0 | 95.0 | 0.0 | 33 | 96 |
| real EN Wikipedia, EN | 3941 | 29.3 | 0.7 | 97.6 | 62.4 | 64.1 | 0.1 | 22 | 75 |
| EN missing apostrophes, EN | 14 | 100.0 | 0.0 | 100.0 | 100.0 | 100.0 | 0.0 | 46 | 113 |
| real NL curated, NL | 60 | 90.0 | 0.0 | 100.0 | 100.0 | 100.0 | 0.0 | 58 | 125 |
| real NL extra, NL | 141 | 86.5 | 0.0 | 100.0 | 94.3 | 97.9 | 0.0 | 42 | 89 |
| real NL all, NL+EN | 201 | 86.1 | 0.0 | 100.0 | 95.5 | 98.5 | 0.0 | 63 | 125 |
| context EN, EN | 1557 | 77.1 | 0.6 | 99.2 | 88.5 | 90.2 | 0.0 | 76 | 279 |
| context NL, NL | 1564 | 68.6 | 0.9 | 98.7 | 85.5 | 88.7 | 0.0 | 68 | 243 |
| context NL, NL+EN | 1564 | 66.7 | 0.8 | 98.8 | 85.2 | 88.5 | 1.2 | 126 | 362 |
| context EN, NL+EN | 1557 | 75.3 | 0.8 | 99.0 | 88.4 | 90.1 | 1.3 | 126 | 397 |
| tap EN usage, EN, with taps | 1500 | 80.1 | 0.7 | 99.1 | 88.9 | 91.6 | 0.0 | 57 | 159 |
| tap EN uniform, EN, with taps | 1500 | 67.5 | 0.9 | 98.7 | 83.1 | 87.7 | 0.0 | 53 | 140 |
| tap NL usage, NL, with taps | 1500 | 78.7 | 0.3 | 99.6 | 88.4 | 90.7 | 0.0 | 58 | 177 |
| tap NL uniform, NL, with taps | 1500 | 70.7 | 1.1 | 98.5 | 83.8 | 87.1 | 0.0 | 52 | 122 |
| tap NL usage, NL+EN, with taps | 1500 | 74.9 | 0.8 | 98.9 | 87.4 | 90.3 | 1.1 | 77 | 231 |
| context EN, EN, with taps | 1557 | 81.9 | 0.6 | 99.3 | 89.4 | 90.2 | 0.0 | 63 | 172 |
| context NL, NL, with taps | 1564 | 75.4 | 1.0 | 98.7 | 86.8 | 88.7 | 0.0 | 68 | 193 |
| context NL, NL+EN, with taps | 1564 | 73.7 | 0.9 | 98.8 | 86.6 | 88.5 | 1.2 | 107 | 435 |
| context EN, EN, words before removed | 1557 | 66.3 | 0.5 | 99.2 | 85.8 | 89.9 | 0.0 | 56 | 202 |
| context NL, NL, words before removed | 1564 | 62.1 | 1.0 | 98.5 | 82.4 | 88.3 | 0.0 | 62 | 255 |
...
- tap EN usage, EN, with taps, missed: deturm [] (meant return); eud [dud, end, feud] (meant did); hdwish [] (meant jewish); ahs [has, as, ah] (meant has); guyss [guys, guess] (meant guys); uor [our, or, for] (meant our); hrad [hard, head, had] (meant hard); nto [not, to, into] (meant not)
- tap EN uniform, EN, with taps, wrong: yees->yes (meant eyes); beautifull->beautiful (meant beautifully); fuucker->fucker (meant fucked); puoned->phoned (meant phones); coigh->cough (meant coughs); cafr->car (meant cafe); dlo->do (meant doo); spmetime->sometime (meant sometimes)
- tap EN uniform, EN, with taps, missed: hoel [hotel, joel, hole] (meant hole); psychologsit [psychologist] (meant psychologist); ibvolvrment [] (meant involvement); tranmsissiion [] (meant transmission); chirs [chris, chairs, chirps] (meant chris); phrse [purse, phrase, phase] (meant phrase); blun [blunt, blunder, bluntly] (meant blunt); atrillery [artillery] (meant artillery)
- tap NL usage, NL, with taps, wrong: niiet->niet (meant niets); trn->ten (meant toen); stopp->stop (meant stoppen); wst->wat (meant wist); blijen->blijven (meant blijken)
- tap NL usage, NL, with taps, missed: waa [was, waar, waarom] (meant waar); saaii [saai, saaie] (meant saai); hoore [hoor, hoorde, hoort] (meant hoorde); zuden [zouden, zuiden, zaden] (meant zouden); lerk [leek, kerk, lek] (meant leek); vinf [vijf, vind, ving] (meant vijf); zt [zit, zat, zet] (meant zit); abnd [band, and, abed] (meant band)
- tap NL uniform, NL, with taps, wrong: hoodd->hoofd (meant hood); pratten->praten (meant praatten); jaer->jaar (meant jager); pzer->per (meant gozer); veroorzaamt->veroorzaakt (meant veroorzaakte); hoogg->hoog (meant hogg); vean->van (meant evan); vehoord->gehoord (meant verhoord)
- tap NL uniform, NL, with taps, missed: tatent [attent, talent, patent] (meant attent); sttructuir [] (meant structuur); resents [presents] (meant presents); buitenaarxea [] (meant buitenaardse); ientificere [] (meant identificeren); onbetrowbaar [onbetrouwbaar] (meant onbetrouwbaar); hsren [haren, heren, horen] (meant haren); weggevne [weggeven] (meant weggeven)
- tap NL usage, NL+EN, with taps, wrong: niiet->niet (meant niets); abnd->and (meant band); dlo->do (meant dol); aint->ain't (meant saint); trn->ten (meant toen); stopp->stop (meant stoppen); bda->bad (meant had); uhj->uh (meant hij)
- tap NL usage, NL+EN, with taps, missed: waa [was, waar, waarom] (meant waar); saaii [saai, saaie] (meant saai); hoore [hoor, hoorde, hoort] (meant hoorde); zuden [zouden, zuiden, zaden] (meant zouden); lerk [leek, kerk, lek] (meant leek); vinf [vijf, vind, ving] (meant vijf); zt [zit, zat, zet] (meant zit); daaoom [daarom] (meant daarom)
- context EN, EN, with taps, wrong: yied->tied (meant tired); mny->my (meant many); thos->this (meant those); awter->water (meant lawyer); cald->cold (meant calf); yhee->thee (meant the); awt->at (meant want); thhs->this (meant the)
- context EN, EN, with taps, missed: cosnultant [consultant] (meant consultant); sausafee [] (meant sausage); confedece [] (meant conference); weere [were, we're, where] (meant were); learniimg [] (meant learning); fvor [for, favor] (meant favor); airllnae [] (meant airplane); arrguments [arguments] (meant arguments)
- context NL, NL, with taps, wrong: kleiin->klein (meant kleine); wgen->wagen (meant eten); llen->allen (meant alleen); gxaan->gaan (meant gedaan); zuwt->zult (meant ziet); wse->we (meant war); gpen->geen (meant gapen); kln->kon (meant komen)
- context NL, NL, with taps, missed: ijn [zijn, in, mijn] (meant zijn); ou [hou, zou, oud] (meant zou); blssenn [] (meant bossen); vestandig [verstandig] (meant verstandig); tebtamen [] (meant tentamen); vdrachting [] (meant verachting); rekeningne [rekeningen] (meant rekeningen); mtt [met, matt, mat] (meant met)
...
- context NL, NL+EN, with taps, missed: ijn [zijn, in, mijn] (meant zijn); ou [hou, out, zou] (meant zou); blssenn [] (meant bossen); vestandig [verstandig] (meant verstandig); tebtamen [] (meant tentamen); vdrachting [] (meant verachting); rekeningne [rekeningen] (meant rekeningen); mtt [met, matt, mutt] (meant met)
