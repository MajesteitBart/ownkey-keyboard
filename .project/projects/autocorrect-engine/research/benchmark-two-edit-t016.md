...
- real NL all, NL+EN, missed: trouwes [trouwens, trouwe, trouwen] (meant trouwens); oko [ook, oké, ok] (meant ook); hbe [heb, he, be] (meant heb); groejtes [groetjes, groente, groepjes] (meant groetjes); groetn [groeten, groten, groen] (meant groeten); eventeel [eventueel, evenveel] (meant eventueel); eevn [even, een, en] (meant even); wekren [werken, weken, weten] (meant werken)
